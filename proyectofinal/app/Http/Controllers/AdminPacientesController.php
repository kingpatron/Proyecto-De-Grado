<?php namespace App\Http\Controllers;
	...
	class AdminPacientesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"C.I","name"=>"cedula"];
			...
			$this->form[] = ['label'=>'C.I','name'=>'cedula','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
