<?php namespace App\Http\Controllers;
	...
	class AdminInventarioMedicamentosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "inventario_medicamentos";
	        ...
	        */
	        $this->sub_module = array();
	         $this->sub_module[] = ['label'=>'Agregar A Inventario','path'=>'registro_inventario_medicamentos','button_color'=>'warning','button_icon'=>'fa fa-pencil-square-o','parent_columns'=>'id,nombre,cantidad,fecha_vencimiento','foreign_key'=>'medicinas_id'];	
